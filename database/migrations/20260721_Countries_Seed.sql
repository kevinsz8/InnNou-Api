-- =============================================================
-- MIGRATION: Seed Countries with the ISO 3166-1 alpha-2 country list
-- Date: 2026-07-21
-- =============================================================
-- One-time seed of the standard ISO 3166-1 alpha-2 country list
-- (~195 UN member/observer states). Guarded so it is a no-op if the
