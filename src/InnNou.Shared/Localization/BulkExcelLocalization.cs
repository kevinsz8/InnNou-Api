...
public static class BulkExcelLocalization
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Headers = new()
    {
        ...
        ["Level1UnitCode"] = new() { ["en"] = "Level 1 Unit", ["es"] = "Unidad Nivel 1", ["ca"] = "Unitat Nivell 1" },
        ["Level1Quantity"] = new() { ["en"] = "Level 1 Quantity", ["es"] = "Cantidad Nivel 1", ["ca"] = "Quantitat Nivell 1" },
        ["Level2UnitCode"] = new() { ["en"] = "Level 2 Unit", ["es"] = "Unidad Nivel 2", ["ca"] = "Unitat Nivell 2" },
        ["Level2Quantity"] = new() { ["en"] = "Level 2 Quantity", ["es"] = "Cantidad Nivel 2", ["ca"] = "Quantitat Nivell 2" },
        ["Level3UnitCode"] = new() { ["en"] = "Level 3 Unit", ["es"] = "Unidad Nivel 3", ["ca"] = "Unitat Nivell 3" },
        ["Level3Quantity"] = new() { ["en"] = "Level 3 Quantity", ["es"] = "Cantidad Nivel 3", ["ca"] = "Quantitat Nivell 3" },
        ["Level4UnitCode"] = new() { ["en"] = "Level 4 Unit", ["es"] = "Unidad Nivel 4", ["ca"] = "Unitat Nivell 4" },
        ["Level4Quantity"] = new() { ["en"] = "Level 4 Quantity", ["es"] = "Cantidad Nivel 4", ["ca"] = "Quantitat Nivell 4" },
        ...
        ["Quantity"] = new() { ["en"] = "Quantity", ["es"] = "Cantidad", ["ca"] = "Quantitat" },
    };
