    ...
    public static class InfrastructureMappings
    {
        ...
        public static void Register(Mapper mapper)
        {
            ...
            mapper.Register<GoodsReceiptSummary, GoodsReceiptSummaryDto>(gr => new GoodsReceiptSummaryDto
            {
                ...
                WarehouseName = gr.WarehouseName,
                DeliveryNoteNumber = gr.DeliveryNoteNumber,
                DeliveryNoteDate = gr.DeliveryNoteDate,
                GoodsReceiptCreatedUtc = gr.GoodsReceiptCreatedUtc,
            ...
            mapper.Register<ArticleEntity, ArticleDto>(e => new ArticleDto
            {
                ...
                PurchaseUnitToken = e.PurchaseUnitToken,
            ...
            mapper.Register<GoodsReceiptEntity, GoodsReceiptDto>(e => new GoodsReceiptDto
            {
                ...
                DeliveryNoteNumber = e.DeliveryNoteNumber,
                DeliveryNoteDate = e.DeliveryNoteDate,
                Notes = e.Notes,
                CreatedUtc = e.CreatedUtc,
                CreatedBy = e.CreatedBy,
                LineCount = e.LineCount
            ...
            mapper.Register<InventoryMovementEntity, InventoryMovementDto>(e => new InventoryMovementDto
            {
                ...
                Quantity = e.Quantity,
                EnteredUnitCode = e.EnteredUnitCode,
                EnteredQuantity = e.EnteredQuantity,
                GoodsReceiptToken = e.GoodsReceiptToken,
            ...
            mapper.Register<InventoryTransferLineEntity, InventoryTransferLineDto>(e => new InventoryTransferLineDto
            {
                ...
                PurchaseUnitCode = e.PurchaseUnitCode,
                Quantity = e.Quantity,
                TransferredUnitCode = e.TransferredUnitCode,
                TransferredQuantity = e.TransferredQuantity,
                Notes = e.Notes,
                CreatedUtc = e.CreatedUtc,
                CreatedBy = e.CreatedBy
            });
            ...
            mapper.Register<InventoryPeriodCount, InventoryPeriodCountDto>(e => new InventoryPeriodCountDto
            {
                ...
                CountedUnitCode = e.CountedUnitCode,
                CountedQuantityInUnit = e.CountedQuantityInUnit,
                CreatedUtc = e.CreatedUtc,
                CreatedBy = e.CreatedBy,
                LastUpdatedUtc = e.LastUpdatedUtc,
                LastUpdatedBy = e.LastUpdatedBy
            ...
            mapper.Register<RequisitionLineEntity, RequisitionLineDto>(e => new RequisitionLineDto
            {
                ...
                RequestedUnitCode = e.RequestedUnitCode,
            ...
            mapper.Register<RequisitionIssueLineEntity, RequisitionIssueLineDto>(e => new RequisitionIssueLineDto
            {
                ...
                PurchaseUnitCode = e.PurchaseUnitCode,
                QuantityIssued = e.QuantityIssued,
                IssuedUnitCode = e.IssuedUnitCode,
                IssuedQuantity = e.IssuedQuantity,
                Notes = e.Notes,
                CreatedUtc = e.CreatedUtc,
                CreatedBy = e.CreatedBy
            });
