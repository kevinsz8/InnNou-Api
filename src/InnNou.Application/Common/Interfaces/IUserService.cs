...
namespace InnNou.Application.Persistence
{
    public interface IUserService
    {
        ...
        Task<PagedResult<UserDto>> GetUsersAsync(int pageNumber, int pageSize, string? searchField, string? searchText, bool includeInactive, List<int>? roleIds, List<int>? organizationIds, IRequestContext context, CancellationToken cancellationToken);
