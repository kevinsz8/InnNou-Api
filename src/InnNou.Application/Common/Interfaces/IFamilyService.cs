...
namespace InnNou.Application.Common.Interfaces
{
    public interface IFamilyService
    {
        ...
        Task<FamilyDto?> SetDefaultTaxCategoryAsync(Guid familyToken, Guid taxCategoryToken, CancellationToken cancellationToken = default);
        ...
        Task<FamilyDto?> SetNameTranslationsAsync(Guid familyToken, Dictionary<string, string> translations, CancellationToken cancellationToken = default);
