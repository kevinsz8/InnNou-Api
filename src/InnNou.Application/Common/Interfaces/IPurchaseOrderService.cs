...
namespace InnNou.Application.Common.Interfaces
{
    ...
    {
        Task<PagedResult<PurchaseOrderDto>> GetPagedAsync(Guid? organizationToken, string? status, int pageNumber, int pageSize, IRequestContext context, CancellationToken cancellationToken);
